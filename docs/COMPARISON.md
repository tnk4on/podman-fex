...
| **Rosetta** | applehv | Binary Translation (AOT) | 54–225ms | 71–281ms | 316–1,322ms |
...
|----------|:-----------------:|:------------------:|:--------------:|
| Emulation method | Binary Translation (AOT) | JIT compilation | Interpreter |
...
([FEX-Emu/FEX — GitHub](https://github.com/FEX-Emu/FEX))
